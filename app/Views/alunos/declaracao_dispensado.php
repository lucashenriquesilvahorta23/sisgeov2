...
<p style="text-align: center;"><strong>DECLARAÇÃO DE TEMPO DE SERVIÇO</strong></p>

<p align="justify">
Declaramos para os devidos fins e a parte interessada que o(a) Sr. (a) <strong><?= $aluno->NOME_PROFISSIONAL; ?></strong>, inscrito(a) no CPF sob o nº <strong><?= $aluno->CPF; ?></strong>, exerceu o cargo
<?php 
    switch($aluno->CARGO) {
        case '1':
            $cargo = 'PROFESSOR(A)';
...
?>
de <strong><?= $cargo; ?></strong>, desde o dia <strong><?= date("d/m/Y", strtotime($aluno->DATA_ADMISSAO)); ?></strong> a <strong><?= date("d/m/Y", strtotime($aluno->DATA_DESLIGAMENTO)); ?></strong>, na <strong><?= mb_strtoupper($escola->ESCOLA, 'UTF-8') ?></strong>, INEP nº <strong><?= $escola->INEP ?></strong>, localizada à <strong><?= $escola->LOGRADOURO ?></strong>, <strong><?= $escola->BAIRRO ?></strong>, CEP: <strong><?= $escola->CEP ?></strong>
