...
<p style="text-align: center;"><strong>DECLARAÇÃO DE TRANSFERÊNCIA DO ALUNO</strong></p>
...
<p align="justify">
    ...
    devidamente matriculado(a), frequentou esta Instituição de Ensino até a data de <?= isset($aluno->DATA_ALTERACAO_SITUACAO) ? date("d/m/Y", strtotime($aluno->DATA_ALTERACAO_SITUACAO)) : date('d/m/Y') ?> 
    do ano letivo de <?= $aluno->ANO_LETIVO ?>, cursando a etapa 
    <?php
    switch ($turma->ETAPA) {
        case 'I1':
...
<p align="justify">
A Escola se compromete a expedir os relatórios de desempenho do aluno no prazo de até 10 (DEZ) dias, ressalvada a necessidade do cumprimento das obrigações do requerente com esta Instituição de Ensino. 
</p>
