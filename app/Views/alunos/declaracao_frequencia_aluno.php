...
<p style="text-align: center;"><strong>DECLARAÇÃO DE FREQUÊNCIA DO ALUNO</strong></p>
...
<p align="justify">
    ...
    está devidamente matriculado(a) e frequentando esta Instituição de Ensino, 
    cursando a etapa 
    <?php
    switch ($turma->ETAPA) {
        case 'I1':
...
<p align="justify">
Este documento tem validade de 30 (trinta) dias a partir de sua expedição e não deve ser aceito na forma de cópia ou para fins de solicitação de vaga em outra Instituição de Ensino. Caso seja necessário tal documento, comparecer a Secretaria da Escola, ressalvada a necessidade do cumprimento das obrigações do requerente com esta Instituição de Ensino.
</p>
