    ...
    <section class="content">
        ...
        <div class="row">	
            <div class="col-lg-12 col-12">
                    ...
                    <!-- /.box-header -->
                    <form novalidate method="POST" action="/Aluno/FotoStore" id="frm" class="validate" enctype='multipart/form-data'>
                        <div class="box-body">
                            <!-- Linha 1 -->
                            <div class="row">
                                <?= csrf_field() ?>
                                ...
                                <div class="col-md-5">                      
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="hidden" name="id_aluno" value="<?= $id_aluno;?>" id="id_aluno">
