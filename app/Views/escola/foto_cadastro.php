 ...
 <div class="content-wrapper" style="margin-left: 300px" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo isset($foto->ID_DOCUMENTO_ESCOLA) ? 'Edição' : 'Cadastro';?> de anexos</li>
      </ol>
    </section>
        ...
        <div class="row">	
            <div class="col-lg-12 col-12">
                    ...
                    <div class="box-header with-border">
                        <h4 class="box-title"><?php echo isset($foto->ID_DOCUMENTO_ESCOLA) ? 'Edição' : 'Cadastro';?> de anexos</h4>			
                    ...
                    <!-- /.box-header -->
                    <form novalidate method="POST" action="/Escola/FotoStore" id="frm" class="validate" enctype='multipart/form-data'>
                        <div class="box-body">
                            <!-- Linha 1 -->
                            <div class="row">
                                <?= csrf_field() ?>
                                ...
                                <div class="col-md-5">                      
                                    <div class="form-group">
                                        <h5>Documento</h5>
                                        <div class="controls">
                                            <input type="hidden" name="id_foto" value="<?php echo isset($foto->ID_DOCUMENTO_ESCOLA) ? $foto->ID_DOCUMENTO_ESCOLA : '';?>" id="id_foto">
                                            <input type="hidden" name="id_escola" value="<?= $id_escola;?>" id="id_escola">
