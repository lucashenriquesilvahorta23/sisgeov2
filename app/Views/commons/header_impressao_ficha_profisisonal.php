        ...
        <div class="col-md-2 "   >
            <?php
                if(isset($aluno->NOME_ALEATORIO) && ($aluno->NOME_ALEATORIO != null || $aluno->NOME_ALEATORIO != "")){
                    echo '	<img style="border: 1px solid #000; border-radius: 8px; margin-left: 8px" src="'.LINK_UPLOAD.$aluno->NOME_ALEATORIO.'"  width=75 class="img-bordered">';
                }else{
                    echo '	<img src="'.LINK_UPLOAD.'padrao.png'.'" width=75 class="img-bordered">';
                }
            ?>
            <p style="font-size: 10px;" >Foto do profisisonal</p>
        </div>
    </div>
