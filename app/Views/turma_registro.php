        ...
        foreach ($resultados as $resultado) {
          ...
          '
            <div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between;border-bottom: 1px solid #000;">
              ...
              <a style="display: contents;" href="/Aplicativo/RegistroNovo/'.$resultado->ID_TURMA.'" ><button style="margin-right: 10px" type="button" class="btn btn-sm btn-danger">Abrir</button></a>
            </div>
          ';
        }
