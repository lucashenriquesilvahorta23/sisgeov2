          ...
          <!-- <form novalidate method="POST" action="/Aplicativo/AcompanhamentoInserir" id="frm" class="validate" enctype='multipart/form-data'> -->
            ...
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="hidden" class="form-control" name="registro_id" id="registro_id" value="<?php echo isset($dados_semestre->ID_REGISTRO_ALUNO) ? $dados_semestre->ID_REGISTRO_ALUNO : '';?>" >
              </div>
              <!-- /.input group -->
            </div>
            ...
            <div class="form-group" >
              <h5 style="color: #000;" class="box-title">Registro <?php echo $semestre == 1 ? " Inicial" : " Final"; ?>  da Criança</h5>

              <div class="input-group">
              <textarea name="descricao" id="descricao" class="form-control"  style="width: 100%; height: 200px;"> <?php echo isset($dados_semestre->DESCRICAO) ? $dados_semestre->DESCRICAO : '';?> </textarea>
              </div>
            ...
            <button type="button" id="gravar_registro" class="btn btn-danger">Salvar</button>         
          <!-- </form>  -->
