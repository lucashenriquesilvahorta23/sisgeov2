...
<div class="content-wrapper" style="margin-left: 300px" >
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-file"></i> REGISTRO DE FRÊQUENCIA
      </h1>
    </section>
    ...
    <div class="row">		
            <div class="col-12">         
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form method="POST" action="/Documento/DocumentoRelatorioDeFrequencia" id="frm" target="_blank" class="validate" enctype='multipart/form-data'>
