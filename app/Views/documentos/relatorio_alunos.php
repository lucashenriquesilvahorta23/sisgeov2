...
<div class="content-wrapper" style="margin-left: 300px" >
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-file"></i> RELATÓRIO DE ALUNOS
      </h1>
    </section>
    ...
    <div class="row">		
            <div class="col-12">         
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form method="POST" action="/Documento/DocumentoRelatorioDeAluno" id="frm" target="_blank" class="validate" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select id="situacao_aluno" name="situacao_aluno" class="form-control">
                                            <option value="">Escolha uma opção</option>
                                            <option value="CO">Progressão Direta</option>
                                            <option value="TR">Transferido</option>
                                            <option value="EV">Evadido</option>
                                            <option value="FL">Falecido</option>
                                            <option value="CU">Cursando</option>
                                        </select>
                                    </div>
                                </div>
