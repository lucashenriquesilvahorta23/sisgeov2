...
<div class="content-wrapper" style="margin-left: 300px" >
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-file"></i> DIAGNÓSTICO DA SALA
      </h1>
    </section>
    ...
    <div class="row">		
            <div class="col-12">         
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form method="POST" action="/Documento/DocumentoRegistroIndividualSala" id="frm" target="_blank" class="validate" enctype='multipart/form-data'>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label style="color: #000000" >Semestre</label>
