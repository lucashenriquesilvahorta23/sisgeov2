    ...
    <section  class="">
      <div class="box">
        <div class="box-header with-border" style="
            ...
            align-items: center;
        " >
          <img onclick="window.location.href='/Aplicativo/Registro'" src="/template/img/seta_esquerda.png" style="max-width: 5%; margin-right: 10px" alt="">
        ...
        <div class="box-body">
          ...
          foreach ($resultados as $resultado) {
            echo 
            '
              <a href="/Aplicativo/RegistroPeriodo/'.$resultado->ID_ALUNO.'/'.$turma->ID_TURMA.'/'.$resultado->SITUACAO.'">
