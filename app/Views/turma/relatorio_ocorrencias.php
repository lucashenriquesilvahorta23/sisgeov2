...
<p style="text-align: center;"><strong>RELATÓRIO DE OCORRÊNCIAS GERAIS</strong></p>

<?php
foreach ($ocorrencias_simples as $ocorrencia) {
    
    $descricao = $ocorrencia->DESCRICAO;
    $dataOcorrencia = inverterData($ocorrencia->DATA)." ".$ocorrencia->HORA;
    ...
    echo "<tr>";
    echo "<th colspan='4'>Titulo:  <span style='font-weight: lighter' >  ".$titulo."  </span></th>";
    echo "</tr>";
